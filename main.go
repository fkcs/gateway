...
func main() {
	...
	etcdEP := flag.String("etcd", "127.0.0.1:2379", "etcd end point")
	dbIP := flag.String("db_ip", "127.0.0.1", "mysql DB IP address")
	...
	redisAddr := flag.String("redis_addr", "127.0.0.1:47001", "redis address")
